...
Welcome to the dedicated documentation suite for **Durability Multiplier** on **Minecraft 26.1.2** (`1.1.9+26.1.2`).
...
| **Mod Version** | `1.1.9+26.1.2` | SemVer release tag |
...
| **DasikLibrary** | `1.8.2` | Shared architecture core |
