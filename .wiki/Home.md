...
Welcome to the dedicated documentation suite for **Durability Multiplier** on **Minecraft 26.2** (`1.2.2+26.2`).
...
| **Mod Version** | `1.2.2+26.2` | SemVer release tag |
...
| **DasikLibrary** | `1.8.3` | Shared architecture core |
| **Registered GameRules** | **25 Static Rules** + Dynamic Mod Rules | 12 Multipliers, 12 Infinities, 1 Tooltip |
| **Mixin Injection Points** | 4 Target Classes | `ItemStack`, `GameRules`, `MappedRegistry` |
...
* [[Durability Multipliers & Categories|Durability-Multipliers]] — Granular 12-category multiplier system and override hierarchy.
* [[God Mode & Infinity|God-Mode-and-Infinity]] — Zero-damage invincibility toggles.
...
* [[Dynamic Modded Item Scanning|Dynamic-Modded-Item-Registration]] — Registry freeze scanner and reflection engine.
* [[Tooltip Indicators & HUD|Tooltip-Indicators-and-HUD]] — Sided item tooltip rendering.
* [[GameRules Reference Table|GameRules]] — Exhaustive reference table for all 25 GameRules.
...
* [[ModVersionGuard Runtime Protection|ModVersionGuard-and-Safety]] — Zero-dependency version guard.
