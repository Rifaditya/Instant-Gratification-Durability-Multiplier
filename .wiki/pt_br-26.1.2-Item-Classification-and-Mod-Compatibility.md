# Classificação de itens e compatibilidade com mods (26.1.2)
...
* Qualquer item com durabilidade que não corresponda às tags ou componentes padrão é atribuído a `OTHER` e gerenciado pelo [[Scanner Dinâmico|pt_br-26.1.2-Dynamic-Modded-Item-Registration]].
