# Clasificación de objetos y compatibilidad con mods (26.2)
...
* Cualquier objeto con durabilidad que no coincida con las etiquetas estándar se asigna a `OTHER` y se gestiona dinámicamente mediante el [[Escáner dinámico|es_es-26.2-Dynamic-Modded-Item-Registration]].
