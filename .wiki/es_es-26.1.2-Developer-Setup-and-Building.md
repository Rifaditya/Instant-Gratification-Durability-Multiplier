# Configuración de desarrollador y compilación (26.1.2)

| Requisito de entorno | Especificación |
| :--- | :--- |
...
| **Minecraft objetivo** | `26.1.2` |
| **Dependencia DasikLibrary** | `1.8.28` |

---

## 🛠️ Comandos de compilación

Ejecutar en la terminal desde el directorio del subproyecto:
...
## 📄 Declaraciones de dependencias (`build.gradle`)
