# Классификация предметов и совместимость с модами (26.2)
...
* Любой предмет с прочностью, не подходящий под стандартные теги или компоненты, относится к `OTHER` и управляется динамически через [[Динамический сканер|ru_ru-26.2-Dynamic-Modded-Item-Registration]].
