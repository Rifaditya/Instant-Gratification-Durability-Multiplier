# Gegenstandsklassifizierung & Mod-Kompatibilität (26.1.2)
...
* Jeder Gegenstand mit Haltbarkeit, der keine Standard-Tags hat, fällt unter `OTHER` und wird über den [[Dynamischen Scanner|de_de-26.1.2-Dynamic-Modded-Item-Registration]] verwaltet.
