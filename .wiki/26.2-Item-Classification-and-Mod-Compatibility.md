...
* Any damageable item that does not match standard tags or components is assigned to `OTHER` and managed dynamically via the [[Dynamic Scanner|26.2-Dynamic-Modded-Item-Registration]].
