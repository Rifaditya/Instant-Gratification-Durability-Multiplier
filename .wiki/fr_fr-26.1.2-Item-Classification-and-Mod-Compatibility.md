# Classification des objets & Compatibilité des mods (26.1.2)
...
* Tout objet avec durabilité sans tags standard est classé dans `OTHER` et géré dynamiquement par le [[Scanner dynamique|fr_fr-26.1.2-Dynamic-Modded-Item-Registration]].
