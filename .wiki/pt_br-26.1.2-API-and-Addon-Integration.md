# Integração de API e addons (26.1.2)

| Fachada de Integração | Pacote / Localização |
| :--- | :--- |
| **Auxiliar Principal** | `net.instantgratification.durabilitymultiplier.DurabilityHelper` |
| **Registro de GameRules** | `net.instantgratification.durabilitymultiplier.registry.DurabilityRules` |
| **Estado do Cliente** | `net.instantgratification.durabilitymultiplier.network.DurabilityClientState` |
| **Regras Dinâmicas** | `net.dasik.social.api.gamerule.DynamicGameRuleManager` |

---

## 🔌 Usando o DurabilityHelper em outros mods

Outros mods do Fabric podem inspecionar o modificador de durabilidade ativo para qualquer pilha de itens:
...
Mods addons podem registrar regras personalizadas na categoria `DURABILITY_MULTIPLIER` usando `DynamicGameRuleManager`:
