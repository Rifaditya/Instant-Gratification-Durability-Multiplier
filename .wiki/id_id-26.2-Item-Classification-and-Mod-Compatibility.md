# Klasifikasi Item & Kompatibilitas Mod (26.2)
...
* Semua item yang tidak cocok dengan tag atau komponen standar ditetapkan ke `OTHER` dan dikelola secara dinamis melalui [[Pemindai Dinamis|id_id-26.2-Dynamic-Modded-Item-Registration]].
