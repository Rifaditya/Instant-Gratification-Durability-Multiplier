# Настройка среды разработчика и сборка (26.1.2)

| Требование к окружению | Спецификация |
| :--- | :--- |
...
| **Целевой Minecraft** | `26.1.2` |
| **Зависимость DasikLibrary** | `1.8.28` |

---

## 🛠️ Команды сборки

Выполните в терминале из директории подпроекта:
...
## 📄 Объявления зависимостей (`build.gradle`)
